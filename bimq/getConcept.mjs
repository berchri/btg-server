...
/*
"project": "Informationsanforderungskatalog für Hochbauprojekte - Swietelsky AG",
"project_id": 2164,
"id": 18738473,
"name": "SWI-HB-Bauelemente",
*/
...
try {
    await mongoose.connect( `mongodb://${name}:${pw}@atsrvbtk001:27017/bimq?authSource=bimq` )
...
const apiRequests = [
    { template: true, root_node_id: 18738473, context: 2164 },
    { template: true, root_node_id: 18767536, context: 2164 },
    { template: false, root_node_id: 18740745, context: 2164 }
]
